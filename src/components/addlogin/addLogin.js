...
class AddLogin extends React.Component {
  ...
  handleSignup() {
   ...
   render() {
    ...
    return (
        <div className="addlogincontainer">
        <div className="addloginbox">
          <h1 className ="addloginheader">Create New Login</h1>
          <select  className = "addloginselect" value = {this.state.unitNumber} onChange = {this.handleChange} name = "unitNumber">
          ...
          autoComplete="off"
            ...
            onChange={this.handleChange}
          />
          <select className = "addloginselect" name="role" onChange = {this.handleChange}>
          ...
          <div className="addloginbuttoncontainer">
          <button className="addloginsubmitbutton" onClick={this.handleSignup}>
            Submit
  
          </button>
          <button className="addloginsubmitbutton" onClick={this.handleCancel}>Cancel</button>
          </div>
